$(document).ready(function () {
   ...
   function delayScanMode(){
      if ($(".option-landing").hasClass("transitionLR")) {
          ...
          $(".option-landing").addClass('transitionLR-reload').show(1000);         
       } else  {
         $(".option-landing-scanmode").hide();
         $(".option-landing").show();
         $(".option-landing-sides").hide();
...
/*Send to contact click button event*/
   ...
   $(".menu-num li").click(function(){
    ...
    //    $(".option-landing").hide(2000);
    //    $(".option-landing").addClass('slidein-from-RL');
       
       $(".option-landing").addClass('transitionLR').hide(500); 
       $(".option-landing-scanmode").addClass('transitionLR-load').show(500); 
    ...
    $(".option-landing ul .option-sides").click(function(event){
       ...
       $(".option-landing").animate({'padding-left':'-100px'}).hide(400);
       $(".option-landing-sides").animate({'padding-left':'-100px'}).show(100);
    ...
    $(".option-landing ul .option-color").click(function(event){           
      $(".option-landing").animate({'padding-left':'-100px'}).hide(400);
      $(".option-landing-sides").hide();
      $(".option-landing-color").animate({'padding-left':'-100px'}).show(100);
      $(".option-landing-color .optionli-color-child1").css('margin-top','-24px');
    ...
    $(".option-landing ul .option-resize").click(function(){ 
      $(".option-landing").animate({'padding-left':'-100px'}).hide(400);
      $(".option-landing-color").hide();
      $(".option-landing-resize").animate({'padding-left':'-100px'}).show(100);
       $(".option-landing-resize .optionli-resize-child1").css('margin-top','-24px');
   ...
   $(".options").click(function(){
      $(".option-landing ul li:first-child").css('height','80px');
      $(".done-but").hide();
   ...
   function hideexample1(){
      $(".example1").hide(); 
      $(".Print-content-copy .option-landing").css('margin-left','655px').show(00);
      $(".Print-content-copy .option-landing").animate({marginLeft: '0px'},500);
      $(".Print-content-copy .option-landing").css('visibility', 'visible');
