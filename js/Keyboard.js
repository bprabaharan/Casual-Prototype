...
var faxAddNumbers = [{"img":"<img class='keyboard-icon' src='./images/Icons_SVG/add_s.svg'>","name":"addNum"},
                        {"img":"<img class='keyboard-icon' src='./images/Icons_SVG/add_contact_m.svg'>","name":"addCont"}];
