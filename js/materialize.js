    ...
    _createClass(Parallax, [{
      ...
      value: function _updateParallax() {
        ...
        if (!this._enabled) {
          ...
          this.$img[0].style.transform = "translate3D(-80%, " + parallax + "px, 0)";
        }
      }
    }], [{
      key: "init",
...
;(function ($) {
  ...
  var _defaults = {
    duration: 300, // ms
    dist: -110, // zoom scale TODO: make this more intuitive as an option
    shift: -50, // spacing for center image
    padding: 160, // Padding between non center items
  ...
  var Carousel = function (_Component18) {
    ...
    function Carousel(el, options) {
      ...
      _this62.dim = _this62.itemWidth * 2.3 + _this62.options.padding || 1; // Make sure dim is non zero for divisions.
